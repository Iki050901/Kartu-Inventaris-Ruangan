...
<body>
    <div class="flex">
        <!-- Sidebar -->
        <div id="sidebar" class="min-h-screen w-64 transition-all duration-300 ease-in-out" style="background-color:#134F86">
            <div class="flex items-center justify-between p-4">
                <div class="flex items-center sidebar-header transition-all duration-300 ease-in-out">
                    <img src="{{ asset('img/ic_person_48px.svg') }}" alt="Super Admin" class="w-8 h-8 text-white transition-opacity duration-300 ease-in-out sidebar-logo">
                    <h4 class="text-white font-semibold ml-3 transition-all duration-300 ease-in-out sidebar-text">Admin</h4>
                </div>
                <button class="text-white" id="sidebarCollapse">&#9776;</button>
            </div>
            <ul class="mt-3 space-y-2">
                <li>
                    <a href="{{ route('dashboard') }}" class="flex items-center p-3 text-white hover:bg-blue-400 hover:text-blue-800 transition-all duration-200 {{ request()->routeIs('dashboard') ? 'bg-blue-400 text-blue-800' : '' }}">
                        <svg class="w-6 h-6 sidebar-icon" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 3l8 6v12h-6v-6h-4v6h-6v-12l8-6z" />
                        </svg>
                        <span class="ml-3 sidebar-text transition-all duration-300 ease-in-out">Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('unit_satuan_kerjas.index') }}" class="flex items-center p-3 text-white hover:bg-blue-400 hover:text-blue-800 transition-all duration-200 {{ request()->routeIs('unit_satuan_kerjas.index') ? 'bg-blue-400 text-blue-800' : '' }}">
                        <svg class="w-6 h-6 sidebar-icon" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M20 8.33363V6.59113C20.0001 6.142 19.8792 5.70114 19.65 5.31489C19.4208 4.92864 19.0918 4.61127 18.6975 4.39613L11.1975 0.3053C10.8304 0.10435 10.4185 -0.000976562 10 -0.000976562C9.58146 -0.000976562 9.16965 0.10435 8.8025 0.3053L1.3025 4.39613C0.908244 4.61127 0.579225 4.92864 0.350027 5.31489C0.120829 5.70114 -8.30872e-05 6.142 4.28364e-08 6.59113V8.33363H2.5V15.8336H0.833333V18.3336H4.28364e-08V20.0003H20V18.3336H19.1667V15.8336H17.5V8.33363H20ZM11.6667 8.33363V15.8336H8.33333V8.33363H11.6667ZM4.16667 8.33363H6.66667V15.8336H4.16667V8.33363ZM15.8333 15.8336H13.3333V8.33363H15.8333V15.8336Z" />
                        </svg>
                        <span class="ml-3 sidebar-text transition-all duration-300 ease-in-out">Data Satuan Kerja</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('laporan.barang') }}" class="flex items-center p-3 text-white hover:bg-blue-400 hover:text-blue-800 transition-all duration-200 {{ request()->routeIs('laporan.barang') ? 'bg-blue-400 text-blue-800' : '' }}">
                        <svg class="w-6 h-6 sidebar-icon" viewBox="0 0 24 24" fill="currentColor">
                ...
                <li>
                    <a href="{{ route('data_pegawais.index') }}" class="flex items-center p-3 text-white hover:bg-blue-400 hover:text-blue-800 transition-all duration-200 {{ request()->routeIs('data_pegawais.index') ? 'bg-blue-400 text-blue-800' : '' }}">
                        <svg class="w-6 h-6 sidebar-icon" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <span class="ml-3 sidebar-text">Data Pegawai</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('profile_admin.index') }}" class="flex items-center p-3 text-white hover:bg-blue-400 hover:text-blue-800 transition-all duration-200 {{ request()->routeIs('profile_admin.index') ? 'bg-blue-400 text-blue-800' : '' }}">
                        <svg class="w-6 h-6 sidebar-icon" viewBox="0 0 24 24" fill="currentColor">
                ...
                <li>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="flex items-center w-full p-3 text-white hover:bg-blue-400 hover:text-blue-800 transition-all duration-200">
                            <svg class="w-6 h-6 sidebar-icon" viewBox="0 0 24 24" fill="currentColor">
