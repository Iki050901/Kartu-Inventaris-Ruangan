...
<div class="flex">
    ...
    <div class="flex-grow p-4">
        <div class="container-fluid">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <!-- Total Kantor -->
                <div class="bg-white text-black p-1 rounded-lg shadow-lg">
                    <div class="card-body">
                        <div class="flex items-center gap-6">
                            ...
                            <div>
                                <h5 class="text-lg font-semibold">Total Kantor</h5>
...
<script>
    document.getElementById('sidebarCollapse').addEventListener('click', function () {
        ...
        // Hide the header (Super Admin logo and text) when sidebar is collapsed
    ...
    const conditionChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: {!! json_encode($tahunPembelian) !!},
            datasets: [
                {
                    label: 'Baik',
                    data: {!! json_encode($jumlahBaik) !!},
                ...
                {
                    label: 'Kurang Baik',
                    data: {!! json_encode($jumlahKurangBaik) !!},
