            ...
            <table class="min-w-full">
                <thead>
                    <tr class="border-b border-gray-200" style="background-color:#A6CEF2">
                        ...
                        <th class="py-2 px-4 text-left text-black">Kantor</th>
                        <th class="py-2 px-4 text-left text-black">No. Kode Lokasi</th>
                        <th class="py-2 px-4 text-left text-black">Alamat</th>
                        <th class="py-2 px-4 text-left text-black">Action</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="py-2 px-4">
                            ...
                            <form action="{{ route('units.destroy', $unit->id) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
                                <button class="bg-red-500 text-white py-1 px-2 rounded shadow hover:bg-red-600 text-sm ml-2" onclick="return confirm('Apakah Anda yakin ingin menghapus unit ini?')">Hapus</button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
