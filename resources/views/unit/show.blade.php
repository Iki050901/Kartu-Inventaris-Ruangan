...
<div class="container mx-auto px-4 mt-5">
    ...
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-3xl font-extrabold text-blue-600">DATA KANTOR</h1>
    </div>

    <!-- Detail Unit -->
    <div class="bg-white p-6 rounded-lg shadow-lg mb-6">
        <h2 class="text-2xl font-bold mb-4">Lihat Kantor</h2>
        ...
        <div class="border border-gray-200 rounded-lg">
            ...
            <div class="p-4">
                <p><strong class="font-semibold">Nama Kantor:</strong> {{ $unit->kantor }}</p>
                <p><strong class="font-semibold">Email Kantor:</strong> {{ $unit->email_kantor }}</p>
                <p><strong class="font-semibold">No. Kode Lokasi:</strong> {{ $unit->no_kode_lokasi }}</p>
                <p><strong class="font-semibold">Alamat Kantor:</strong> {{ $unit->alamat_kantor }}</p>
            </div>
        </div>
        
        <h3 class="text-xl font-semibold mt-6">Kepala Dinas</h3>
